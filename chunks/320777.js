function(e, _, E) {
    ...
    new(0, A.default)().log("[BUILD INFO] Release Channel: ".concat(u, ", Build Number: ").concat("277493", ", Version Hash: ").concat("dfaa7af007592f6053576752db568891fbb6162f")), t.default.setTags({
