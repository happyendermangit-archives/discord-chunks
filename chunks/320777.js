function(e, _, E) {
    ...
    new(0, A.default)().log("[BUILD INFO] Release Channel: ".concat(L, ", Build Number: ").concat("272138", ", Version Hash: ").concat("a6a38bd742785e5e9ca8f40d3171d192930be25f")), t.default.setTags({
