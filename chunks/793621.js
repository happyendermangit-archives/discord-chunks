function(t, e, i) {
            ...
            children: Object.keys(a).map(t => {
                ...
                return v ? o = (0, l.jsx)(O.default, {
                    ...
                    children: [(0, l.jsxs)("div", {
                        ...
                        return n(null != i, "connectionMetadataField is null"), n(null != r, "operator is null"), n(null != a, "value is null"), (0, l.jsx)(L, {
                            connectionType: e,
    ...
    function D(t) {
        ...
        return e = 1 === n.length && 1 === n[0].length ? P.default.Messages.CONNECTIONS_ROLE_POPOUT_HEADER_ONE : 1 === n.length ? P.default.Messages.CONNECTIONS_ROLE_POPOUT_HEADER_ALL.format() : P.default.Messages.CONNECTIONS_ROLE_POPOUT_HEADER_OR.format(), (0, l.jsxs)("div", {
            className: b.popout,
    ...
    function U(t) {
        let {
            ...
            guild: i,
            channel: a
        } = t, s = (0, E.default)(i, e, a.id, !0), o = (0, d.useStateFromStores)([I.default], () => I.default.getGuildRoleConnectionEligibility(null == s ? void 0 : s.id)), [c, h] = r.useState(null == o);
        if (null == s) return null;
        async function x() {
            n(null != s, "visibleConnectionsRole is null"), c && null == o && (await f.default.fetchGuildRoleConnectionsEligibility(i.id, s.id), h(!1))
        }
        return (0, l.jsx)(u.LazyPopout, {
            ...
            renderPopout: function() {
                return Promise.resolve(t => {
                    ...
                    return null == o ? (0, l.jsx)(l.Fragment, {}) : (n(null != s, "visibleConnectionsRole is null"), (0, l.jsx)(D, {
                        eligibilityStates: o,
                        userId: e,
                        roleId: s.id,
                        channelId: a.id,
