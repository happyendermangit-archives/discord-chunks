    ...
    let f = (0, E.promiseThrottle)(l.fetchStickerPacks, T.REQUEST_THROTTLE_DURATION_MS),
        S = (e, t, n) => {
            let r = (0, u.useHasSendableSticker)(n),
                s = (0, a.useStateFromStores)([_.default], () => _.default.getCurrentUser());
            return i.useMemo(() => {
                ...
                c.default.queryStickers(d, !1).forEach(e => {
                    let {
                        sticker: t
                    } = e, i = (0, o.getStickerSendability)(t, s, n), r = {
                        sticker: t,
                        sendability: i
                    };
                    i === o.StickerSendability.SENDABLE ? a.push(r) : i === o.StickerSendability.SENDABLE_WITH_PREMIUM && l.push(r)
                });
                let _ = [];
        ...
        h = e => {
            ...
            } = e, l = i.useRef(null), u = i.useRef(!1), _ = i.useRef(!1), c = i.useMemo(() => s()(t, null != o ? o : T.DELAY_BEFORE_SUGGESTIONS_MS), [t, o]);
            return {
                handleTextChange: async e => {
                    var i;
                    if (null == e || "" === e) c.cancel(), null == t || t(""), null == n || n(!1), null == r || r(!1), null == a || a(null), l.current = null, u.current = !1;
