function(e, t, n) {
    ...
    class ei {
        ...
        handleOpen() {
            Y.info("WS Connected"), this.backoff.succeed(), this.pingInterval.start(M, () => this.ping()), (0, P.getProfile)(this.accountId, this.accessToken), (0, P.getDevices)(this.accountId, this.accessToken)
        }
        handleMessage(e) {
            let {
                data: t
        ...
        constructor(e, t) {
            this._requestedDisconnect = !1, this._requestedConnect = !1, this.handleDeviceStateChange = u.throttle(() => {
                (0, P.getDevices)(this.accountId, this.accessToken), eg(this.accountId, this.accessToken)
            }, H), this.accountId = e, this.accessToken = t, this.pingInterval = new c.Interval, this.backoff = new l.default(void 0, F), this.connect()
        }
    }
    ...
    function ed(e, t, n) {
        ...
        let l = null != u && null != u.start ? u.start : Date.now(),
            ...
            _ = !1,
            c = Z[r.accountId];
        null != c && !1 === c.repeat && (_ = null), (0, P.play)(r.accountId, r.accessToken, o, {
            position: +f,
            deviceId: a.id,
            repeat: _
        }), i = {
        ...
        n && (g = "started", D.default.track(V.AnalyticEvents.SPOTIFY_LISTEN_ALONG_STARTED, {
            party_id: d.id,
            other_user_id: e
    ...
    function eu() {
        ...
        null != s && s.track.id === e && (0, P.pause)(n.accountId, n.accessToken)
    }
    ...
    function ef() {
        ...
        J = !0, (0, P.pause)(t.accountId, t.accessToken), D.default.track(V.AnalyticEvents.SPOTIFY_AUTO_PAUSED), Y.info("Playback auto paused")
    }
    ...
    function ec(e, t, n) {
        ...
        if (null != r && !0 !== r.is_active && (r = {
            ...
            i = null != n && null != n.context && n.context.uri === l.uri ? Promise.resolve(n.context) : l.type === b.SpotifyResourceTypes.ALBUM ? Promise.resolve(l) : P.SpotifyAPI.get(e, t, {
                url: l.href
            }).then(e => {
                let {
                    body: t
    ...
    class em extends f.default.Store {
        ...
        canPlay(e) {
            ...
            return null != ee() && null != t && null != n && null != n.id && (0, b.isSpotifyParty)(n.id)
        }
        getSyncingWith() {
            return i
        }
        ...
        getActivity() {
            ...
            return !l && (v.sync_id = d, v.flags = V.ActivityFlags.PLAY | V.ActivityFlags.SYNC, v.metadata = {
                context_uri: t,
                album_id: a.id,
                artist_ids: c.map(e => {
                    let {
    ...
    let eh = new em(g.default, {
        ...
        ACTIVITY_PLAY: function(e) {
            ...
            null != s && (t = s.context_uri), null != i && eu(), (0, P.play)(a.accountId, a.accessToken, d, {
                contextUri: t,
                deviceId: o.id
