function(e, t, n) {
    ...
    var T = e => {
        let {
            location: t
        } = e, n = (0, l.useStateFromStores)([E.default], () => E.default.isAuthenticated()), T = (0, l.useStateFromStores)([_.default], () => _.default.hasLoadedExperiments), N = (0, c.useIsUnauthenticatedReportFormEnabled)("RSL - Landing Page"), [g, A] = a.useState(!1), [S, C] = a.useState(p.default.Messages.AUTHORIZING), [v, O] = a.useState(!0), R = e => {
            switch (e) {
