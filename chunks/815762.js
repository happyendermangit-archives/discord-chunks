function(e, t, n) {
    ...
    var m = e => {
        let {
            location: t
        } = e, n = (0, l.useStateFromStores)([E.default], () => E.default.isAuthenticated()), m = (0, l.useStateFromStores)([I.default], () => I.default.hasLoadedExperiments), N = (0, c.useIsUnauthenticatedReportFormEnabled)("RSL - Landing Page"), [g, A] = a.useState(!1), [S, v] = a.useState(p.default.Messages.AUTHORIZING), [O, C] = a.useState(!0), R = e => {
            switch (e) {
