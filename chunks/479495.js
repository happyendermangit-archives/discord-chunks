function(e, t, n) {
    ...
    class v extends(s = i.PureComponent) {
        componentDidMount() {
        ...
        renderPasswordReset() {
            let {
                ...
                error: t,
                hasCancel: s
            } = this.state, i = this.isSubmitting(), l = null != t ? t : this.renderError("password");
        ...
        constructor(e) {
            ...
            super(e), S(this, "handleSubmit", async e => {
                ...
                if (null != t && (r = (0, E.default)(t)), null != r) {
                    ...
                    try {
                        let {
                            ...
                            totp: o,
                            backup: d
                        } = await f.default.resetPassword(r, i, s);
                ...
                f.default.loginReset(), e(N.Routes.LOGIN)
            }), S(this, "isSubmitting", () => {
                let {
                    loginStatus: e
                } = this.props, {
