function(t, e, i) {
    ...
    function W(t) {
        let {
            ...
            className: M,
            channel: S
        } = t, P = r.useMemo(() => null != s ? t => s(t, e) : void 0, [s, e]), [, k] = (0, h.default)(e.author.id, t.guildId), G = (0, o.useStateFromStores)([T.default], () => T.default.getGuild(t.guildId), [t.guildId]), Z = null != e.author && null != G && I.default.canManageUser(B.Permissions.MODERATE_MEMBERS, e.author, G), W = k && Z, K = F({
            props: t,
            guildId: t.guildId,
