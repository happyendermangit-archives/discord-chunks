function(e, t, n) {
    ...
    function f(e) {
        ...
        let {
            commands: h
        } = o.useCommandsForApplication(f, t, n), m = r.useMemo(() => null == h ? void 0 : h.filter(e => !0 !== e.nsfw), [h]), N = r.useCallback(e => {
            null == A || A(), d.default.track(c.AnalyticEvents.POPULAR_APPLICATION_COMMAND_CLICKED, {
                application_id: t,
                command_id: e,
                guild_id: S,
