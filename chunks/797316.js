function(e, t, n) {
    ...
    function L(e, t) {
        ...
        g.forEach(r => {
            var a;
            r !== R.default.getGuildId() && r !== N.default.getGuildId() && r !== (null === (a = S.default.getChannel(O.default.getChannelId())) || void 0 === a ? void 0 : a.getGuildId()) && (null == i || i.guildId !== r) && (g.clearWithoutFlushing(r, e), t && (n[r] = g.get(r)))
