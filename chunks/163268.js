function(e, t, n) {
    ...
    function B(e) {
        ...
        } = G(), s = h.default.getChannel(e.channel_id);
        if (null == s) return !1;
    ...
    function V(e, t) {
        ...
        switch (e.type) {
            ...
            case 2:
                return (0, p.hasFlag)(null !== (a = null === (r = e.media.contentScanMetadata) || void 0 === r ? void 0 : r.contentScanFlags) && void 0 !== a ? a : 0, I.ContentScanFlags.EXPLICIT);
            default:
                return !1
        }
    }
