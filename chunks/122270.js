    ...
    let p = {
        ...
        renderResults(e) {
            let t, n, {
                ...
                I = x.mentions.user === d.UserMentionMode.DENY;
            return I ? (t = f.default.Messages.ROLES_MATCHING, n = f.default.Messages.ROLES) : (t = f.default.Messages.MEMBERS_MATCHING, n = f.default.Messages.MEMBERS), (0, i.jsxs)(l.Fragment, {
