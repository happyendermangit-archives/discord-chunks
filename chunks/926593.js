            ...
            switch (e.state) {
                ...
                case R.GuildTemplateStates.RESOLVED:
                    ...
                    if (this.props.login) return (0, s.jsx)(S.default, {
                        ...
                        location: l,
                        onRegister: () => {
                            (0, h.setNewUser)(L.NewUserTypes.ORGANIC_REGISTERED_GUILD_TEMPLATE), m.default.flowStart(x.FlowType.ORGANIC_GUILD_TEMPLATES, x.RegistrationSteps.NUF_STARTED)
                        }
                    });
