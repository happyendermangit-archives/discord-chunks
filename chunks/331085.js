            ...
            return o.useEffect(() => {
                ...
                return a.onmessage = async t => {
                    ...
                    switch (s.op) {
                        ...
                        case "pending_ticket": {
                            m.ComponentDispatch.dispatch(I.ComponentActions.WAVE_EMPHASIZE), l("remote auth handshake started, awaiting ticket/cancel.");
                        ...
                        case "pending_finish": {
                            m.ComponentDispatch.dispatch(I.ComponentActions.WAVE_EMPHASIZE), l("remote auth handshake started, awaiting finish/cancel.");
                            let e = s.encrypted_user_payload,
                                t = await (0, T.decodeEncodedUserRecord)(_(), e);
                            r({
                                step: 2,
                        ...
                        case "finish": {
                            m.ComponentDispatch.dispatch(I.ComponentActions.WAVE_EMPHASIZE), l("remote auth handshake finished.");
