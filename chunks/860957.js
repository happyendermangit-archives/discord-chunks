function(e, t, n) {
    ...
    let eN = new ey(u.default, __OVERLAY__ ? {
        ...
        RPC_SERVER_READY: function(e) {
            ...
            s.append("build_id", "ebeff92239031674a4807e8b96d1e19ae927b0ca"), s.append("rpc", String(t)), s.append("rpc_auth_token", Y), i = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(s.toString())
        },
