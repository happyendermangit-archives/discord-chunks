        ...
        var e = {
                ...
                convert: {
                    fromCodePoint: function(e) {
                        ...
                        return t < 65536 ? a(t) : a(55296 + ((t -= 65536) >> 10), 56320 + (1023 & t))
                    },
                    toCodePoint: h
                },
                onerror: function() {
                ...
                parse: function(t, r) {
                    ...
                    return (!r || "function" == typeof r) && (r = {
                        ...
                        for (var r, i, o, a, u, l, f, p, h, v, g, b, m, y = function e(t, n) {
                            ...
                            for (o = !1, a = document.createDocumentFragment(), l = (u = y[x]).nodeValue, p = 0; f = n.exec(l);) {
                                if ((h = f.index) !== p && a.appendChild(c(l.slice(p, h), !0)), b = d(g = f[0]), p = h + g.length, m = t.callback(b, t), b && m) {
