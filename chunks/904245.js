function(e, t, n) {
    ...
    function eT(e) {
        ...
        } = e, o = (0, O.parseExtraDataFromInviteKey)(t), l = Y.default.getChannel(n);
        if (null != l) {
            let e = null;
        ...
        eS = {
            ...
            _sendMessage(e, t, n) {
                ...
                if (!eE && null != _ && _.length > 0) {
                    let t, n;
                    eE = !0;
                    let i = Z.default.getCurrentUser();
                ...
                return null != R && (x.message.poll = R), null != h && (x.message.sticker_ids = h), P.default.isEnabled() && (x.message.has_poggermode_enabled = !0), new Promise((t, i) => {
                    ...
                    ec.info("Queueing message to be sent LogId:".concat(_)), u.default.enqueue(x, u => {
                        let _ = Date.now() - s;
                        if (u.ok) L.default.donateSentMessage(l, e), eS.receiveMessage(e, u.body, !0, {
                            ...
                            message: {
                                channel_id: e,
                                author: Z.default.getCurrentUser()
                            }
                        }), ! function(e) {
                            let {
                                content: t,
