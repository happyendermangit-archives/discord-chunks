function(e, t, n) {
        ...
        render() {
            ...
            switch (e.state) {
                ...
                case b.InviteStates.RESOLVED:
                    var r;
                    if (n && (0, L.hasFlag)(null !== (r = e.flags) && void 0 !== r ? r : 0, i.GuildInviteFlags.IS_GUEST_INVITE)) return c.default.openApp(e.code), d.default.set(m.GUEST_INVITE_KEY, e.code), this.renderAppOpened(() => a(b.Routes.APP));
    ...
    var K = o.default.connectStores([v.default, C.default, S.default, p.default, E.default], e => {
        var t;
        let {
            inviteKey: n
        } = e;
