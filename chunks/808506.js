function(e, t, n) {
    ...
    let eM = new ev(E.default, __OVERLAY__ ? {
        ...
        RPC_SERVER_READY: function(e) {
            ...
            n.append("build_id", "85f2f92f266d5ae3e2b11e1c4b0ecb31349f0e09"), n.append("rpc", String(t)), n.append("rpc_auth_token", z), i = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
        },
