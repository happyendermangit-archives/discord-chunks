function(e, t, n) {
    ...
    t.default = {
        ...
        async attemptPomelo(e) {
            ...
            let g = (t = e, !1 === /^[A-Za-z0-9_.]*$/.test(t) ? h.default.Messages.POMELO_EXISTING_FLOW_ERROR_INVALID : t.includes("..") ? h.default.Messages.POMELO_EXISTING_FLOW_ERROR_DOT_DOT : t.length < 2 || t.length > 32 ? h.default.Messages.POMELO_EXISTING_FLOW_ERROR_LIMIT.format({
                maxNum: 32,
                minNum: 2
            }) : void 0);
            if (null != g) return l.default.track(f.AnalyticEvents.POMELO_ERRORS, {
                reason: g,
                username_error: !0,
                location: a,
                one_click_flow: c
